...
public final class Predicates {
  ...
  public static <A, B> Predicate<A> compose(Function<A, ? extends B> function, Predicate<B> predicate) {
    if (function == null) {
      throw new IllegalArgumentException("Compose Function cannot be null");
    }
    if (predicate == null) {
      throw new IllegalArgumentException("Compose Predicate cannot be null");
    }
   ...
   * @return a predicate
   */
  public static <T> Predicate<T> equalTo(Object target) {
    return target == null ? (o) -> o == null : target::equals;
  }
   ...
   * @return a predicate
   */
  public static <A, B> Predicate<A> equalTo(Function<A, ? extends B> composeFunction, Object target) {
  ...
  private enum ObjectPredicate implements Predicate<Object> {
    ALWAYS_TRUE {
      ...
      @Override
      public Predicate<? super Object> and(Predicate<? super Object> other) {
        return other;
      }

      @Override
      public Predicate<? super Object> or(Predicate<? super Object> other) {
        return this;
      }
